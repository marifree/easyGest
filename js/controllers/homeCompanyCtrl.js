...
/*
  ...
  $scope.activity = [
	  {
		what: 'Maria Laura Fresu',
		who: 'marialaurafresu@gmail.com',
		when: '3:08PM',
		notes: " I'll be in your neighborhood doing errands"
	  },
	  {
		what: 'Pinco Pallino',
		who: 'pincopallino@alice.it',
		when: '3:08PM',
		notes: "Wish I could come out but I'm out of town this weekend"
	  },
	  {
		what: 'Mario Rossi',
		who: 'mario_rossi@tiscali.it',
		when: '3:08PM',
		notes: "Do you have Paris recommendations? Have you ever been?"
	  },
	  {
		what: 'Valeria Bianchi',
		who: 'valeriab@gmail.com',
		when: '3:08PM',
		notes: "Have any ideas of what we should get Heidi for her birthday?"
	  },
	  {
		what: 'Antonello Verdi',
		who: 'verdiantonello@tiscali.it',
		when: '3:08PM',
